...
class QCPRELOADQUALITY(models.Model):
    _name = 'qc.pre.load.wizard'
    ...
    def get_qc_pre_load_report(self):
        ...
        return self.env.ref('qc_reports.report_qc_pre_load').report_action(self, data=data)


class QCPACKHOUSEREPORT(models.AbstractModel):
    _name = 'report.qc_reports.print_qc_pre_load_details_template'
    _description = 'QC PRE Load Quality Report'
